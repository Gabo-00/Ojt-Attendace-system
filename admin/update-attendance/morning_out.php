...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `attendance` SET `morning_out`='$time' WHERE id ='$id' ";
...
<body>
    ...
    <div class="main-container1">
        ...
        <h5><a href="../view-students.php?studentID=<?php echo $row['student_id'] ?>"><span
                    ...
                    <h2 style=" text-align: center;">Edit Morning TimeOut</h2>
                    <!-- delete student --> <br>
                    <hr>
                    ...
                    <form action=" " method="POST">
                        ...
                        <!-- --------------------------------------------- -->
                        <div class="form-group">
                            <label for="email">Afternoon TimeOut</label>
                            <!-- miorning_in condition -->

                            <?php if($row2['morning_out'] == NULL || $row2['morning_out'] == "00:00:00"){ ?>
                            <input type="text" class="form-control" name="time1" value="NULL">
                            <?php }else{ ?>
                            <input type="text" class="form-control" name="time1" value="<?php echo $time_formatted ?> " readonly>
                            <?php } ?>
