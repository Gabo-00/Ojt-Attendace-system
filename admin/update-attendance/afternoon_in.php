...
if(isset($_POST['submit'])){
    ...
    if($time==0){
        $sql = "UPDATE `attendance` SET `afternoon_in`='$time',`afternoon_out`='$time' WHERE id ='$id' ";
...
<body>
    ...
    <div class="main-container1">
        ...
        <h5><a href="../view-students.php?studentID=<?php echo $row['student_id'] ?>"><span
                    ...
                    <h2 style=" text-align: center;">Edit Afternoon TimeIn</h2>
                    <!-- delete student --> <br>
                    <hr/>
                    ...
                    <form action=" " method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <?php if($row2['afternoon_in'] == NULL || $row2['afternoon_in'] == "00:00:00"){ ?>
