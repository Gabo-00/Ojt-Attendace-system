...
if(isset($_POST['submit'])){
    ...
    $sql = "UPDATE `attendance` SET `morning_in`='$time' WHERE id ='$id' ";
...
<body>
    ...
    <div class="main-container1">
        ...
        <div class="table1">
            ...
            <h2 style=" text-align: center;">Edit Morning TimeIn</h2>
            <!-- delete student --> <br>
            <hr>
            ...
            <form action=" " method="POST">
                ...
                <!-- --------------------------------------------- -->
                <div class="form-group">
                    <label for="email">Morning TimeIn</label>
                    <!-- miorning_in condition -->

                    <?php if($row2['morning_in'] == NULL || $row2['morning_in'] == "12:00 AM"){ ?>
